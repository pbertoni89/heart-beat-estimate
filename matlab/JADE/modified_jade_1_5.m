...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% Cumulant estimation
%% If you prefer to use more CPU and less RAM, you may prefer this code (due to J. Galy of ENSICA) for the estimation the cumulants
%R	= (Y*Y' )/T ;
%C	= (Y*Y.')/T ;
...
%% If you prefer to use more memory and less CPU, you may prefer this code (due to J. Galy of ENSICA) for the estimation the cumulants
ones_m = ones(m,1) ; 
T1 	= kron(ones_m,Y); 
T2 	= kron(Y,ones_m);  
TT 	= (T1.* conj(T2)) ;
